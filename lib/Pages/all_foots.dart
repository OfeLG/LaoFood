...
import 'package:loafood/Pages/OthersPage/foot_details.dart';

class AllFoots extends StatelessWidget {
  final List<ModelRandomFood> footsList;
  const AllFoots({super.key, required this.footsList});
  @override
  Widget build(BuildContext context) {
    //Se crea la cuadricula de cuantas columnas se desea mostrar
    return GridView.builder(
      itemCount: footsList.length,
...
class AllSingleProducts extends StatefulWidget {
  final ModelRandomFood footsList;
  const AllSingleProducts({super.key, required this.footsList});
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => Details(widget.footsList)),
        );
      },
      child: Column(
        children: [
                ...
                Align(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      ...
                      favoriteList.add(widget.footsList);
                    },
          ...
          Container(
            ...
            height: 80,
            child: ListTile(
              title: Text((widget.footsList.name.length > 20)
                  ? widget.footsList.name.substring(0, 20)
                  : widget.footsList.name + "..."),
              subtitle: Text(
                "${widget.footsList.category}",
              ...
              children: [
                Container(
                  ...
                  child: _buildIconText(
                    ...
                    Colors.white,
                    widget.footsList.time.toString(),
                  ),
                ),
                Container(
                  width: 78,
                  ...
                  child: _buildIconText(
                    ...
                    Colors.white,
                    (widget.footsList.calories.toString().length > 4)
                        ? widget.footsList.calories.toString().substring(0, 4)
                        : widget.footsList.calories.toString(),
                  ),
                ),
              ],
            ),
